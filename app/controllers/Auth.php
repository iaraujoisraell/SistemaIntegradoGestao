...
class Auth extends MY_Controller
{
    ...
    function create_user_new()
    {
        ...
        if($valor == 0){
              $this->load->view($this->theme . 'sig/auth/create_user_new', $this->data);
        }
            /*
             * VALIDA O EMAIL
             */
    ...
    public function reset_password($code = NULL)
    {
        ...
        if ($user) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                //render
                $this->load->view($this->theme . 'sig/auth/reset_password', $this->data);
            } else {
    ...
    function deactivate($id = NULL)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            if ($this->input->post('deactivate')) {
                ...
                $this->load->view($this->theme . 'sig/auth/deactivate_user', $this->data);
            }
        } else {
