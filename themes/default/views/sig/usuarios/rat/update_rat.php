                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                            ...
                                                            <div class="col-md-12"  >
                                                                <h4>2 - Selecione a função e o módulo que deseja relacionar à RAT.</h4>
                                                                <div class="form-group">
                                                                ...
                                                                <?php
                                                                        ...
                                                                        $wu5['N/A'] = 'N/A';
                                                                            ...
                                                                            $funcoes = $this->atas_model->getModulosFuncaoByProjeto($projeto);
                                                                             $cont_funcao = 1;
                                                                            foreach ($funcoes as $funcao) {
                                                                                    $wu5[$funcao->id] = $cont_funcao++.' - '.$funcao->modulo.' - '. resume($funcao->funcao, 100);
                                                                            }
                                                                     
                                                                            foreach ($modulosRat as $moduloRat) {
                                                                                $wu6[$moduloRat->funcao] = $moduloRat->funcao;
                                                                            }
                                                                                 echo form_dropdown('funcao[]', $wu5, (isset($_POST['funcao']) ? $_POST['funcao'] : $wu6), 'id="slResponsavel"  class="form-control  select" data-placeholder="' . lang("Selecione") . ' "  style="width:100%; height: 200px;" multiple ');
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="col-lg-2">
                                                                <h4>6 - Tipo de Hora</h4>
                                                                <select required="true" class="form-control" name="tipo">
                                                                    <option value="<?php echo $dados_rat->tipo_hora; ?>"> <?php echo $dados_rat->tipo_hora; ?></option>
                                                            ...
                                                            <div class="col-lg-4">
                                                                ...
                                                                <input type="text" maxlength="250" name="conteudo" value='<?php echo $dados_rat->descricao; ?>' required="true" class="form-control" placeholder="Conteúdo do Treinamento">
                                                            </div>
                                                        </div>
                                                        <center>
