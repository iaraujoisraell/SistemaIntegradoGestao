                                                                    ...
                                                                    <table style="width: 100%;" id="example-table" class="table table-striped table-bordered table-hover table-green">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th style="width: 15%;">MÓDULO/FUNÇÃO</th>
                                                                        ...
                                                                        <tbody>
                                                                             ...
                                                                             function dateDiff( $dateStart, $dateEnd, $format = '%a' ) {
                                                                                ...
                                                                                ?>   
                                                                                    ...
                                                                                    <td style="width: 15%;" class="center">
                                                                                         <?php
                                                                                        $modulos_rats = $this->atas_model->getModulosFuncaoByRat($rat->id);
                                                                                        foreach ($modulos_rats as $modulo_rat) {
                                                                                        ?>
                                                                                        <p>  <?php echo $modulo_rat->modulos.'/'.$modulo_rat->funcao; ?></p>
                                                                                        <?php
                                                                                        }
                                                                                        ?>
