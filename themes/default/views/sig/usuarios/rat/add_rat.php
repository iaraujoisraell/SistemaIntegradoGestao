                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-12">
                                                                ...
                                                                <?php
                                                                        ...
                                                                        $wu5['N/A'] = 'N/A';
                                                                            ...
                                                                            foreach ($funcoes as $funcao) {
                                                                                 ...
                                                                                 echo form_dropdown('funcao[]', $wu5, (isset($_POST['funcao']) ? $_POST['funcao'] : ""), 'id="slResponsavel"  class="form-control  select" data-placeholder="' . lang("Selecione") . ' "  style="width:100%; height: 200px;" required="true" multiple ');
                                                        ...
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <h4>7 - Descrição da Atividade</h4>
                                                                <input type="text" maxlength="250" name="conteudo" required="true" class="form-control" placeholder="Descreva a Atividade">
                                                            </div>
                                                        </div>
                                                        <center>
