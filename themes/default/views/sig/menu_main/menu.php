                                ...
                                <div class="portlet-body">
                                    ...
                                    <div class="row">
                                     <!-- DASHBOARD -->
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/marcos_projeto/' . $projetos->projeto_atual) ?>">
                                                ...
                                                <div class="circle-tile-content btn-orange">
                                                    ...
                                                    <a href="<?= site_url('Sig/marcos_projeto/' . $projetos->projeto_atual) ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/escopo/'. $projetos->projeto_atual) ?>">
                                                ...
                                                <div class="circle-tile-content gray">
                                                    ...
                                                    <a href="<?= site_url('Sig/escopo/'. $projetos->projeto_atual) ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/escopo_resumido/'. $projetos->projeto_atual) ?>">
                                                    <div class="circle-tile-heading gray">
                                                ...
                                                <div class="circle-tile-content gray">
                                                    ...
                                                    <a href="<?= site_url('Sig/escopo_resumido/'. $projetos->projeto_atual) ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/eap/'.$projetos->projeto_atual) ?>">
                                                ...
                                                <div class="circle-tile-content btn-primary">
                                                    ...
                                                    <a href="<?= site_url('Sig/eap/'.$projetos->projeto_atual) ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                    <!-- FIM CRONOGRAMA -->
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/treinamentos_projeto/'.$projetos->projeto_atual) ?>">
                                                ...
                                                <div class="circle-tile-content btn-green">
                                                    ...
                                                    <a href="<?= site_url('Sig/treinamentos_projeto/'.$projetos->projeto_atual) ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                ...
                                                <div class="circle-tile-content btn-facebook">
                                                    ...
                                                    <a href="<?= site_url('Sig/equipe') ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                ...
                                                <div class="circle-tile-content btn-facebook">
                                                    ...
                                                    <a href="<?= site_url('Sig/migracao') ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                      ...
                                      <?php if ($projetos->projeto_atual == 13){ ?>
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/reajuste_cadastro') ?>">
                                                    <div class="circle-tile-heading btn-facebook">
                                                        <i class="fa fa-crosshairs fa-fw fa-3x"></i>
                                                    </div>
                                                </a>
                                                <div class="circle-tile-content btn-facebook">
                                                    ...
                                                    <a href="<?= site_url('Sig/reajuste_cadastro') ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                     ...
                                     <?php if ($permissao_pesquisa_satisfacao){ ?>
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/documentos') ?>">
                                                    <div class="circle-tile-heading btn-green">
                                                ...
                                                <div class="circle-tile-content btn-green">
                                                    ...
                                                    <a href="<?= site_url('Sig/documentos') ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="circle-tile">
                                                <a href="<?= site_url('Sig/inconsistencias') ?>">
                                                    <div class="circle-tile-heading btn-pinterest">
                                                        <i class="fa fa-crosshairs fa-fw fa-3x"></i>
                                                    </div>
                                                </a>
                                                <div class="circle-tile-content btn-pinterest">
                                                    ...
                                                    <a href="<?= site_url('Sig/inconsistencias') ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="col-lg-3 col-sm-6">
                                            <div class="circle-tile">
                                                ...
                                                <div class="circle-tile-content btn-vk">
                                                    ...
                                                    <a href="<?= site_url('Sig/modulos') ?>" class="circle-tile-footer">Acessar <i class="fa fa-chevron-circle-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
