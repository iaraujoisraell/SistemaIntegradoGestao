...
/*#endregion*/
                ...
                ?>
                <div class="row">
                     <a href="<?= site_url('Sig/eap_pdf/'.$id_projeto) ?>">
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                <a style="background-color: <?php echo $cor_evento; ?>; color: <?php echo $color_evento; ?>;" href="<?= site_url('Sig/eap_tipo/'.$tipo_evento2) ?>">
                                                                                ...
                                                                                <ul >
                                                                                        ...
                                                                                        <a style="background-color: <?php echo $cor; ?>; color: <?php echo $color; ?>;"  href="<?= site_url('Sig/eap_evento/'.$evento->id) ?>">

                                                                                            <div  class="container-fluid">
                                                                                                <div class="row">
                                                                                                    <?php echo  'ID:'.$evento->id.' '.$evento->nome_evento; ?>
                                                                                                </div>
