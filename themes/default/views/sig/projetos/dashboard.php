                ...
                <nav class="navbar-top"  role="navigation">
                    ...
                    <div style="width: 420px;"  class="navbar-header">
                        ...
                        <ul  class="nav navbar-left">
                            <li >
                                <a style="height:50px; width: 90px; color: #ffffff;"  class="gray dropdown-toggle" href="<?= site_url('Sig/menu'); ?>">
                        ...
                        <ul   class="nav navbar-left">
                          ...
                          <li style="width: 200px; " >
                                <a style="margin-left: -20px; margin-top: -6px; "  href="<?= site_url('Sig/menu'); ?>" class=" dropdown-toggle" >
                                ...
                                <div class="portlet portlet-blue">
                                    ...
                                    <div  id="main_content_wrap" class="outer">
                                        <section id="main_content" class="inner">
                                            ...
                                            <div style="height:600px;" id="example" ></div>
